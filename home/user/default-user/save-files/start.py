...
class System_commands():
    ...
    def back_old(self, args):
        pygame.quit()
        os.system("python .\\home\\user\\default-user\\save-files\\old-ui\\start.py" if os.name == 'nt' else "python ./home/user/default-user/save-files/old-ui/start.py")
